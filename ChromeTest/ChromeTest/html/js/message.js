...
var message = {
    ...
    run: function(msg = "success", type = 'success', time = 2000) {
        // 显示时间
        this.time = time;
    ...
    // 信息显示区域展示
    boxShowTime: function(inside, insideSetTime, outsideShow) {
    ...
    // 信息区显示
    insideTime: function(inside, outsideShow) {
